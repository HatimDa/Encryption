...
public class Event {
    ...
    public Event(String title, String[] address, String duration) {
        this.title = title;
        this.address = address;
        this.duration = duration;
    }

    public Event(String title, String[] address, Date date, String duration,
                 int[] participantIDs, int notification, int priority, int ownerID) {
        this.id = 0;
        this.title = title;
        this.address = address;
        this.date = date;
    ...
    public Event(int id, String title, String[] address, Date date, String duration,
                 int[] participantIDs, int notification, int priority, int ownerID) {
        this.id = id;
        this.title = title;
        this.address = address;
